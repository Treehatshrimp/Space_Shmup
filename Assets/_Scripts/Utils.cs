...
public class Utils : MonoBehaviour
{
    ...
    /// <param name="points">An ammount of Vector3s to interpolate</param>
    ...
    static public Vector3 Bezier(float u, params Vector3[] points)
    {
        ...
        // itterate over all remaining rows and interpolate points at each one
        for (r--; r >= 0; r--)
        {
            for (int c = 0; c <= r; c++)
            {
    ...
    // == Materials Function ============================================================== \\
    /// <summary>
    /// Returns a list of all materials on this gameoject and its children
    /// </summary>
