...
public class PowerUp : MonoBehaviour
{
    ...
    public TextMeshPro letter; //Reference to the Text Mesh Pro
    ...
    void Awake()
    {
        ...
        //Quaternion.identity is equal to no ratation
    ...
    void Update()
    {
        ...
        //If u>0, descrease the opacity of the PowerCube & letter
        if(u>0)
        {
            Color c = cubeMat.color;
            c.a = 1f - u; //Set the alpha of PowerCube to 1-u
            cubeMat.color = c;
            //Fade the Letter too, not as much
            c = letter.color;
    ...
    public void SetType(eWeaponType wt) 
    {
        ...
        //letter.color = def.color; //Color letter optional
